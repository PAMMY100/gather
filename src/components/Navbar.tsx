...
const Navbar = () => {
  return (
    <div className="h-24 flex items-center justify-between">
      {/* LEFT */}
      <div className="md:hidden lg:block w-[20px]">
        <Link href="/" className="font-bold text-xl text-blue-600">
          Gather
        </Link>
      </div>
      {/* CENTER */}
      <div className="hidden md:flex justify-between w-[50%] text-sm items-center">
        ...
        <div className="hidden xl:flex xl:justify-around p-2 bg-slate-100 items-center rounded-xl">
          <input
            type="text"
            placeholder="search..."
      ...
      {/* RIGHT */}
      <div className="w-[30%] flex items-center gap-4 xl:gap-8">
        <ClerkLoading>
